            ...
            <div className="dashboard-body">
                ...
                <div className="breadcrumb mb-24">
                    <ul className="flex-align gap-4">
                        ...
                        <li>
                            <span className="text-main-600 fw-normal text-15">Pricing Plan</span>
                        </li>
                    </ul>
                </div>
                        ...
                        <div className="row gy-4">
                            ...
                            <div className="col-md-4 col-sm-6">
                                <div className="plan-item rounded-16 border border-gray-100 transition-2 position-relative active">
                                    ...
                                    <a href="#" className="btn btn-primary w-100 rounded-pill py-16 border-main-600 text-17 fw-medium mt-32">Get Started</a>
                                </div>
                            </div>
                            <div className="col-md-4 col-sm-6">
                                <div className="plan-item rounded-16 border border-gray-100 transition-2 position-relative">
                            ...
                            <div className="col-12">
                                ...
                                <label className="form-label mb-8 h6 mt-32 fontBold">Terms & Policy</label>

                                <ul className="list-inside mt-3">
                                    <li className="text-gray-600 mb-2">1. Set up multiple pricing levels with different features and functionalities to maximize revenue</li>
                                    <li className="text-gray-600 mb-2">2. Continuously test different price points and discounts to find the sweet spot that resonates with your target audience</li>
                                    <li className="text-gray-600 mb-2">3. Price your course based on the perceived value it provides to students, considering factors</li>
                                </ul>

                                <button type="button" className="btn btn-primary text-sm btn-sm px-24 rounded-pill py-12 d-flex align-items-center gap-2 mt-24" data-bs-toggle="modal" data-bs-target="#exampleModal">
