                        ...
                        <ul className="flex-align gap-4">
                            ...
                            <li>
                                <span className="text-gray-500 fw-normal d-flex">
                                    <i className="ph ph-caret-right"></i></span>
                            </li>
                            <li>
                                <span className="text-main-600 fw-normal text-15">Assignments</span>
                            </li>
                        </ul>
                    </div>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div className="flex-align gap-8">
                                            <img src={studentImg} alt="" className="w-40 h-40 rounded-circle" />
                                            <span className="h6 mb-0 fw-medium text-gray-300">Jane Cooper</span>
                                        </div>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Web & Mobile Design</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Nov 18, 2024</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Nov 18, 2024</span>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div className="flex-align gap-8">
                                            <img src={studentImg} alt="" className="w-40 h-40 rounded-circle" />
                                            <span className="h6 mb-0 fw-medium text-gray-300">Albert Flores</span>
                                        </div>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Graphics Design</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Dec 18, 2024</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Feb 18, 2025</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div className="flex-align gap-8">
                                            <img src={studentImg} alt="" className="w-40 h-40 rounded-circle" />
                                            <span className="h6 mb-0 fw-medium text-gray-300">Leslie Alexander</span>
                                        </div>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Figma</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Feb 18, 2024</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Nov 18, 2024</span>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div className="flex-align gap-8">
                                            <img src={studentImg} alt="" className="w-40 h-40 rounded-circle" />
                                            <span className="h6 mb-0 fw-medium text-gray-300">Guy Hawkins</span>
                                        </div>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Creating Web Design</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">June 18, 2024</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">June 21, 2024</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div className="flex-align gap-8">
                                            <img src={studentImg} alt="" className="w-40 h-40 rounded-circle" />
                                            <span className="h6 mb-0 fw-medium text-gray-300">Jacob Jones</span>
                                        </div>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Complete Wordpress Course</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">June 18, 2024</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">July 18, 2024</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Webflow Essentials Course</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Aug 18, 2024</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Sep 18, 2024</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Beginners Guide to Design</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Sep 18, 2024</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Sep 22, 2024</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">AngularJS Crash Course </span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Oct 19, 2024</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Nov 18, 2024</span>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div className="flex-align gap-8">
                                            <img src={studentImg} alt="" className="w-40 h-40 rounded-circle" />
                                            <span className="h6 mb-0 fw-medium text-gray-300">Jenny Wilson</span>
                                        </div>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Complete Wordpress Course</span>
                                ...
                                <tr>
                                    <td>
                                        <div className="flex-align gap-8">
                                            <img src={studentImg} alt="" className="w-40 h-40 rounded-circle" />
                                            <span className="h6 mb-0 fw-medium text-gray-300">Sunny Maria</span>
                                        </div>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Responsive Web Design</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Nov 18, 2024</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Oct 18, 2024</span>
                                    </td>
                                    <td>
                                        <span className="text-13 py-2 px-8 bg-success-50 text-success-600 d-inline-flex align-items-center gap-8 rounded-pill">
                                            <span className="w-6 h-6 bg-success-600 rounded-circle flex-shrink-0"></span>
                                ...
                                <tr>
                                    <td>
                                        <div className="flex-align gap-8">
                                            <img src={studentImg} alt="" className="w-40 h-40 rounded-circle" />
                                            <span className="h6 mb-0 fw-medium text-gray-300">Eleanor Pena</span>
                                        </div>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Theme Development</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Oct 18, 2024</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Dec 20, 2024</span>
                                    </td>
                                    <td>
                                        <span className="text-13 py-2 px-8 bg-success-50 text-success-600 d-inline-flex align-items-center gap-8 rounded-pill">
                                            <span className="w-6 h-6 bg-success-600 rounded-circle flex-shrink-0"></span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Complete Python Bootcamp</span>
                                    </td>
                                    <td>
                                        <span className="h6 mb-0 fw-medium text-gray-300">Nov 18, 2024</span>
                                    </td>
